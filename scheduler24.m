%function[n,t,solution,MaxBattCharge,MinBattCharge,HighThresh,LowThresh,PV,app_TW,price,price_code]= scheduler24(Monte)
...
% MCA FOR 1v2 # of valid scheds
Monte = 1;

%% run from here if monte carlo is done from previous case
